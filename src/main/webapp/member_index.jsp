    ...
    <div class="Top">
        <div class="Top_one">
            ...
            <h1>
                ...
                <em><a href="member_index.jsp" class="amy">我的账户</a><!--因该是从首页直接跳member_index.jsp，现在测试先跳后台-->
...
<div class="Content">
    ...
    <div class="Index_left">
        ...
        <div class="userinfo">
            <dl>
                <dt>
                    <img width="100" height="100" alt="头像" src="http://s1.ly333.com/pic/user/my_index/head.png">
                    <span>会员级别：普通会员</span></dt>
                <dd>
                    <p><strong>${frontUser.username}</strong>您好！欢迎使用远景网。</p>
                    <p>&nbsp;
                        <a href="member.jsp">修改个人资料</a>
                    </p>
