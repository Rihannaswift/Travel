        ...
        <div class="step" style="padding:5px;">
            ...
            <div class="body">
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    ...
                    <tr>
                        <td class="td_1">
                            <a class="line" href="preferInfo.html">
                                <img width="64" height="48" alt="" src="images/zixun_ad02.jpg" /><br /><span>广州至深圳罗湖关口单人套票</span>
                            </a>
                        </td>
                        <td>
                            2013-01-20
                        ...
                        <td>
                            <div id="24110403-change">
                                <p class="state_2">已提交验证码，等待报名</p>

                            </div>
                        </td>
                        <td class="td_5">
                            <p id="24110403-details" class="detail">
                                <a href="booking_step3.html">【查看详情】</a></p>
                        </td>
                    </tr>
                    <tr>
                        <td class="td_1">
                        ...
                        <td>
                            <div id="24110403-change">
                                <p class="state_2">已报名</p>

                            </div>
                        </td>
                        <td class="td_5">
                            <p id="24110403-details" class="detail">
                                <a href="booking_step4.html">【查看详情】</a></p>
                        </td>
                    </tr>
                    <tr>
                        <td class="td_1">
    ...
    <div class="Index_right">
        ...
        <div class="Sidemenu">
            ...
            <div class="membermenu">
                <p><a class="open" id="right01" href="member.html">我的信息</a>
                <div class="memberdiv">
                    <a id="m01" href="member.html">个人资料</a>
                    <a id="m02" href="password.html">修改密码</a>
                    <a id="m03" href="#">常用地址</a>
                </div>
                <p><a class="open" id="right02" href="#">我的订单</a>
                <div class="memberdiv">
                    <a id="m04" href="#">旅游订单</a>
                    <a id="m05" href="orders.html">团购订单</a>
                </div>
            </div>
            <!--选中菜单-->
            <script language="javascript" type="text/javascript">
