...
<!--内容-->
<div class="Content">
    <div class="Current">您当前的位置：<a href="#">首页</a> > 旅游资讯</div>
    ...
    <div class="Index_left newsI">
        ...
        <ul class="newsLsit">
            <li>
                <a href="newsInfo.jsp">库尔勒巴音布鲁克草原简介</a>
                <p>巴音布鲁克草原，蒙古语意为"泉源丰富"，远在2600年前，这里即有姑师人活动。清乾隆三十六年(1771年)，土尔扈特、和硕特等</p>
                <span>发布日期：2012-12-20   来源：本站   点击次数：600</span>
            </li>
            <li>
                <a href="newsInfo.jsp">库尔勒巴音布鲁克草原简介</a>
                <p>巴音布鲁克草原，蒙古语意为"泉源丰富"，远在2600年前，这里即有姑师人活动。清乾隆三十六年(1771年)，土尔扈特、和硕特等</p>
