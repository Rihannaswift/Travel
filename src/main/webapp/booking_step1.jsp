...
<div class="Content">
    ...
    <div class="Index_left">
        <div class="step">
            <h2>请选择您的团购来源：（您团购的网站名称，如拉手网）</h2>

            <ul class="site-list mz-fix-float">
                <li><a  class="select-site-btn" href="javascript:void(0)"><img src="images/yuyue01_11.jpg" /><span  class="corner"></span></a> </li>
                <li><a  class="select-site-btn" href="javascript:void(0)"><img src="images/yuyue01_11.jpg" /><span  class="corner"></span></a> </li>
                <li><a  class="select-site-btn" href="javascript:void(0)"><img src="images/yuyue01_11.jpg" /><span  class="corner"></span></a> </li>
                <li><a  class="select-site-btn" href="#"><img src="images/yuyue01_11.jpg" /><span  class="corner"></span></a> </li>
                <li><a  class="select-site-btn" href="#"><img src="images/yuyue01_11.jpg" /><span  class="corner"></span></a> </li>
                <li><a  class="select-site-btn" href="#"><img src="images/yuyue01_11.jpg" /><span  class="corner"></span></a> </li>
                <li><a  class="select-site-btn" href="#"><img src="images/yuyue01_11.jpg" /><span  class="corner"></span></a> </li>
                <li><a  class="select-site-btn" href="#"><img src="images/yuyue01_11.jpg" /><span  class="corner"></span></a> </li>
            ...
            <div class="travel-info-panel" style="display: none;">
                <a class="close-btn ir" href="javascript:void(0)">× 关闭</a>
                <ul class="travel-list">
                    <li>
                        <a href="booking_step2.html">
                            <span class="price"> 团购价：558元</span>
                            【春节阳朔专线】白天出发"仅2期"！仅售558元！即可享受原价1525元的阳朔3天豪华游</a></li>
                    </li>
                    <li>
                        <a href="booking_step2.html">
                            <span class="price"> 团购价：558元</span>
            ...
            <script type="text/javascript">
                $(".select-site-btn").bind("click",function(){
                    $(".site-list li").removeClass("selected");
                    $(this).parent().addClass("selected");
                    var index = $(".site-list li").index($(".selected"));
                    var current = (index)/6;
                    var currentInt = parseInt(current);
                    $(".travel-info-panel").hide();
                    $(".travel-info-panel").slideDown().css("top",(46+((currentInt+1) * 116))+"px");
                })
            </script>
        </div>
    ...
    <div class="Index_right">
        <!---->
        <div class="Sidemenu">
            <h1><img src="images/th_title.jpg" /></h1>
            <dl>
                <dd><a id="right01" href="prefer_today.html">今日特惠</a></dd>
                <dd><a id="right02" href="prefer_today.html">往期特惠</a></dd>
                <dd><a id="right03" href="booking.html">预约验证</a></dd>
            </dl>
            <!--选中菜单-->
            <script language="javascript" type="text/javascript">
                try{
        ...
        <div style="position:relative;">
            ...
            <ul style="height:272px; overflow:hidden;">
                <li>
                    <p>
                        <a href="#">
