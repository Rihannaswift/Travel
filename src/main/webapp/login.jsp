...
<div class="Content">
    ...
    <div class="mod">
        <div class="title">
            <h1 class="hide_word">
                用户登陆</h1>
            <span>或<a href="register.jsp">注册</a></span>
        </div>
        ...
        <table cellpadding="0" cellspacing="0" border="0">
            <tr>
                ...
                <td>
                    <input type="text" maxlength="30" name="username" class="input username" datatype="*" nullmsg="用户名不能为空">
                </td>
                <td>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="password" maxlength="30" name="password" class="input password" datatype="*" nullmsg="密码不能为空">
                </td>
                <td>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="checkbox" id="checkbox1" value="true" name="rememberMe" class="checkbox"><label for="checkbox1">记住我的登录状态</label>
                </td>
                <td>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="submit" value="" class="submit"><a href="found_password.jsp" class="jsp">忘记密码？</a>
                </td>
                <td>
                </td>
            </tr>
