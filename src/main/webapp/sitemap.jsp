...
<!--内容-->
<div class="Content">
    <div class="Current">您当前的位置：<a href="#">首页</a> > 网站地图</div>

    <!--左-->
    <div class="Index_left newsI">

        <div class="aboutInfo padding">
            单篇页面，图文混排介绍
    ...
    <div class="Index_right">
        <!---->
        <div class="Sidemenu">
            <h1><img src="images/column_title.jpg" /></h1>
            <dl>
                <dd><a id="right01" href="sitemap.html">网站地图</a></dd>
                <dd><a id="right02" href="sitemap.html">法律声明</a></dd>
                <dd><a id="right03" href="help.html">帮助中心</a></dd>
                <dd><a id="right04" href="links.html">友情链接</a></dd>
            </dl>
