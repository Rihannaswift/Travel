...
<div class="Content">
    ...
    <div class="Index_left" style="float:right;">
        ...
        <dl class="topicList_dl">
            <dt>
                <a href="topicListInfo.jsp"><img src="images/guonei_pic.jpg" /></a>
                <h2><a href="topicListInfo.jsp">广西桂林靖江王府、叠彩山、漓江精华游、阳朔西街双卧5天游</a></h2>
                <p>挂绿，是荔枝最佳品种之一，主产于广东增城。该品种为广东增城荔枝中的优等品种，也是广东荔枝的名种之一。该品种今存者为1979年古树枯死时由技术人员抢救由树基发芽更生出的新树。挂绿核大而略扁，肉质特别爽脆，清甜有微香，品质极优，果实较耐贮藏。由于挂绿荔枝异常珍贵...</p>
                <span><a href="topicListInfo.jsp">查看详情>> </a></span>
            </dt>
            <dt>
    ...
    <div class="Index_right" style="float:left;">
        ...
        <div class="Sidemenu">
            ...
            <dl>
                <dd><a id="right01" href="topicInfo.jsp">景点介绍</a></dd>
                <dd><a id="right02" href="topicList.jsp">景点线路</a></dd>
            </dl>
            <!--选中菜单-->
            <script language="javascript" type="text/javascript">
                try{
