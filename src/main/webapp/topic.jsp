...
<!--内容-->
<div class="Content">
    <div class="Current">您当前的位置：<a href="#">首页</a> > 专题</div>
    ...
    <ul class="TopicList">
        ...
        <li><a href="topicInfo.jsp">
            <img src="images/lpic02.jpg" />
            <h1>山水主题</h1>
            <span class="four"></span>
        </a></li>
        <li><a href="#">
        ...
        <script type="text/javascript">
            $(".TopicList li").each(function (i, item) {
                if (Number(i + 1) % 4 == 0) {
                    $(this).attr("class", "end");
                }
            });
            $(".right dd").each(function (i, item) {
                if (Number(i + 1) % 2 == 0) {
                    $(this).attr("class", "end");
                }
            });
